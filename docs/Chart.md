...
|Name|Type|Description|Default|
|----|----|-----------|-------|
|labelFormatStringX|`String`|see y-axis counterpart in `Plot`|uses value of `labelFormatStringY`<br>if not set|
...
|numAxisTicksX|`int`|see y-axis counterpart in `Plot`|5|